# Skyexchfast — Search Engine Submission Guide
...
3. Enter: `https://skyexchfast.live/`
...
7. Go to **URL Inspection**, paste each important URL, and click **Request Indexing**:
   - `https://skyexchfast.live/`
   - `https://skyexchfast.live/cricket`
   - `https://skyexchfast.live/casino`
   - `https://skyexchfast.live/blog`
   - Each blog post URL
...
4. Or add manually: enter `https://skyexchfast.live/`, verify via meta tag (same flow as Google)
5. Submit sitemap: `https://skyexchfast.live/sitemap.xml`

    ...
    >
      ...
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link
          ...
          aria-label="Skyexchfast home - Skyexchfast Login online cricket platform"
        >
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          >
            <a href={LOGIN_URL} target="_blank" rel="noopener noreferrer" aria-label="Login to Skyexchfast">

    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container py-12 md:py-20">
        ...
        <div className="max-w-3xl mb-12">
          <div className="text-xs font-semibold tracking-widest text-primary uppercase mb-3">About Skyexchfast</div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-5">
            India's most trusted <span className="text-gradient-gold">online sports gaming platform</span>
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            Skyexchfast (Skyexchfast Login) has been India's leading online cricket & casino platform since 2017.
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start mb-16">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Skyexchfast was founded in 2017 with one mission — make online sports gaming in India simple, safe and lightning fast. No long signup forms, no email verification delays, no hidden fees.
            </p>
            <p className="text-muted-foreground mb-4">
              Today, Skyexchfast serves over 10 lakh active players across India, processing more than ₹500 crore in payouts. We power live cricket betting on IPL, T20 World Cup, ODI and Test cricket — plus 1000+ casino games including Andar Bahar, Teen Patti, Aviator and live dealer roulette.
            </p>
            <p className="text-muted-foreground">
              Every Skyexchfast account is created on WhatsApp, secured with bank-grade SSL, and supported 24x7 by real humans — not chatbots.
            </p>
          </div>

      ...
      jsonLd: [
        {
          ...
          author: { "@type": "Organization", name: "Skyexchfast" },
          publisher: {
            "@type": "Organization",
            name: "Skyexchfast",
            logo: {
      ...
      <article className="container py-10 md:py-16 max-w-3xl">
        ...
        <div className="mt-12 p-6 md:p-8 rounded-2xl border border-primary/30 bg-gradient-card text-center shadow-gold">
          <h3 className="text-xl md:text-2xl font-extrabold mb-2">
            Ready to play on <span className="text-gradient-gold">Skyexchfast?</span>
          </h3>
        ...
        {related.length > 0 && (
          <section className="mt-16">
            <h2 className="text-2xl font-extrabold mb-5">Related Skyexchfast guides</h2>

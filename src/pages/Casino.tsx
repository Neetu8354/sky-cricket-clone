...
const Casino = () => {
  useEffect(() => {
    applySeo({
      title: "Live Casino India 2026 | Andar Bahar, Teen Patti, Aviator | Skyexchfast",
      description:
        "Play live casino games in India on Skyexchfast — Andar Bahar, Teen Patti, Aviator, Roulette, Dragon Tiger and 1000+ titles. INR deposits, instant withdrawal, 24x7 support.",
      canonical: "https://skyexchfast.live/casino",
      keywords:
        "live casino india, andar bahar online, teen patti, aviator game, dragon tiger, online sports gaming platform, skyexchfast online platform, mobile friendly sports betting platforms",
      jsonLd: [
        {
        ...
        <div className="container py-12 md:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-7 max-w-2xl">
              Play Andar Bahar, Teen Patti, Aviator, Roulette and 1000+ live dealer games on the Skyexchfast online platform.
          ...
          {games.map((g) => (
            <div key={g.t} className="relative rounded-2xl overflow-hidden border border-border bg-gradient-card group hover:border-primary/60 transition">
              <div className="aspect-square overflow-hidden">
                <img src={g.img} alt={`Play ${g.t} live online at skyexchfast.live - online sports gaming platform`} loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              </div>
              {g.tag && (

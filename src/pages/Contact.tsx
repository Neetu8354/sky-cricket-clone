...
const Contact = () => {
  ...
  const reasons = [
    { icon: MessageCircle, t: "New Skyexchfast ID", d: "Get your username & password in 60 seconds." },
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container py-12 md:py-20">
        ...
        <div className="max-w-3xl mb-12">
          <div className="text-xs font-semibold tracking-widest text-primary uppercase mb-3">Contact Skyexchfast</div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-5">
            24x7 <span className="text-gradient-gold">WhatsApp support</span> — real humans, instant replies
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            Skyexchfast support is online round the clock. Whether you need a new Skyexchfast Login ID,
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start mb-16">
          <div className="p-8 rounded-2xl border border-primary/30 bg-gradient-card shadow-gold">
            ...
            <p className="text-muted-foreground mb-6">
              The fastest way to reach Skyexchfast. Open WhatsApp, send a "Hi", and our team replies within 60 seconds — in Hindi or English.
            </p>

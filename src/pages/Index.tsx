...
const Index = () => {
  useEffect(() => {
    document.title = "Skyexchfast Login | Online Cricket & Casino ID | Play Fast in ₹";
    ...
    ensure('meta[name="twitter:description"]', { name: "twitter:description", content: "Skyexchfast — Skyexchfast Login for online cricket betting & live casino. Instant ID on WhatsApp." });
  }, []);
